resource "helm_release" "aws_ebs_csi" {
  ...
  set = [
    ...
    { name = "node.resources.requests.cpu", value = "10m" },
    { name = "node.resources.limits.cpu", value = "20m" },
    { name = "node.resources.requests.memory", value = "64Mi" },
    { name = "node.resources.limits.memory", value = "128Mi" },
    ...
    { name = "controller.resources.limits.cpu", value = "20m" },
